$.extend({
    message: function (msg, type, delay, options) {
// options:{
//         message (String)
//         type(String) 可选值'success','info','error','warning',默认info
...
//     }
        ...
        if (!msgType.hasOwnProperty(type.toLowerCase())) type = 'info';

        var messageBox = $('<div class="message-box"><img src=" ' + msgType[type].icon +
            '" class="message-icon"><div class="message-group"><p class="message-content">' + msg + '</p>' + '</div></div>');
...
MessageConstructor.prototype.init = function (options) {
    ...
    if (this.options.showClose) {
        closeBtn = '<div class="jq-message__closeBtn"></div>'
    }
    var msg = '<div class="jq-message ' + this.customClass + '" id="' + msgId + '">' +
